...
@Composable
fun TvScreenInfoScreen(viewModel: ScreenInfoViewModel = koinViewModel()) {
    val uiState by viewModel.uiStateFlow.collectAsStateWithLifecycle()
    TvScreenInfoScreen(uiState = uiState)
}

@Composable
fun TvScreenInfoScreen(uiState: ScreenInfoViewModel.UiState) {
    LazyColumn(
