...
@Composable expect fun VerticalScrollbar(modifier: Modifier, scrollState: LazyListState)

@Composable expect fun HorizontalScrollbar(modifier: Modifier, scrollState: ScrollState)

@Composable expect fun HorizontalScrollbar(modifier: Modifier, scrollState: LazyListState)
