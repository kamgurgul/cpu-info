...
public abstract class AnimatedRoundCornerProgressBar extends BaseRoundCornerProgressBar {
    ...
    public void setupStyleable(@NonNull Context context, @NonNull AttributeSet attrs) {
        ...
        isAnimationEnabled = typedArray.getBoolean(R.styleable.AnimatedRoundCornerProgressBar_animationEnable, false);
        animationSpeedScale = typedArray.getFloat(R.styleable.AnimatedRoundCornerProgressBar_animationSpeedScale, 1f);
        typedArray.recycle();
