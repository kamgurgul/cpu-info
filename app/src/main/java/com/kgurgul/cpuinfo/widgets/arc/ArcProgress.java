...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_suffix_text = "%";
        default_bottom_text_size = sp2px(getResources(), 22);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        rectF.set(strokeWidth / 2f + shadowWidth, strokeWidth / 2f + shadowWidth,
                width - strokeWidth / 2f - shadowWidth,
                MeasureSpec.getSize(heightMeasureSpec) - strokeWidth / 2f - shadowWidth);
